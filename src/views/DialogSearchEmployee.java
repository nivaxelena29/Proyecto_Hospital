 ...
 * Clase JDialog - Buscar funcionario
 */

public class DialogSearchEmployee extends JDialog {
	...
	public DialogSearchEmployee( Controller controller) {
		setSize(360,210);
		...
		JLabel labelTitle= new JLabel("Buscar funcionario", SwingConstants.CENTER);
	...
	public JPanel panelFormulario(Controller controller ){
		...
		UtilitiesEdit.addActionButton(buttonSearch, controller, Action.SEARCH_EMPLOYEE);

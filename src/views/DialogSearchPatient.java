 ...
 * Clase JDialog - Buscar paciente
 */

public class DialogSearchPatient extends JDialog {
	...
	public DialogSearchPatient(Controller controller ) {
		setSize(360,210);
		...
		JLabel labelTitle= new JLabel("Buscar paciente", SwingConstants.CENTER);
	...
	public JPanel panelFormulario( Controller controller){
		...
		UtilitiesEdit.addActionButton(buttonSearch, controller, Action.SEARCH_PATIENT);
		UtilitiesEdit.editGridbag(d, 4, 0.1, 4, 4);
		panelOne.add(buttonSearch,d);
		return panelOne;
	}
	
	public String searhPatient() {
